...
@app.route("/group_ip_list/<groupname>")
...
@app.route("/check_pass_group/<group>/<password>")
...
@app.route("/message_get/<group_name>")
...
@app.route("/send_group/<message>/<group>/<password>")
...
@app.route("/start_group/<group_name>/<password>")
